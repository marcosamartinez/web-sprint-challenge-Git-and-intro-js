...
function artistInfo(array, name) {
  ...
  for (let i = 0; i < array.length; i++) {
    if (array[i].name === name) {
      list.push(array[i].bio);
    }
  }
  return list;
}
console.log(artistInfo(artists, "Edouard Manet"));
...
For example artistByCountry(, 'Spanish') will return: [ 'Salvador Dali', 'Pablo Picasso', 'Francisco Goya', 'El Greco' ]
*/
